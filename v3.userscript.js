...
// @author       SecretCandyMan - https://github.com/SecretCandyMan/
...
(function() {
            ...
            <div style="background: rgba(255,255,255,0.1); padding: 15px; border-bottom: 1px solid rgba(255,255,255,0.1);">
                <div style="display: flex; justify-content: space-between; align-items: center;">
                    <div>
                        ...
                        <p style="margin: 5px 0 0 0; font-size: 12px; opacity: 0.8;" id="status-text">Real Size Detection</p>
                    </div>
    ...
    function handleButtonClick(e) {
        ...
        } else if (cls.includes('toggle-url-entry')) {
            const entry = btn.closest('[data-url]');
            const content = entry.querySelector('.url-entry-content');
            const isCollapsed = content.style.display === 'none';
            content.style.display = isCollapsed ? 'block' : 'none';
            btn.innerHTML = isCollapsed ? '▼' : '▶';
            btn.style.transform = isCollapsed ? 'rotate(0deg)' : 'rotate(0deg)';
        }
    }
        ...
        entry.innerHTML = `
            <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 10px;">
                <div style="display: flex; gap: 8px; align-items: center;">
                    <button class="toggle-url-entry" style="background: rgba(255,255,255,0.2); border: none; color: white; width: 24px; height: 24px; cursor: pointer; border-radius: 6px; font-size: 12px; display: flex; align-items: center; justify-content: center; transition: all 0.2s;">▼</button>
    ...
    console.log('[HLS Extractor Pro] Loaded (toggle button added)');
})();
