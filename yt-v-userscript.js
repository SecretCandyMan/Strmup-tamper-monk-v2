        ...
        setTimeout(async () => {
            ...
            analyzeBtn.addEventListener('click', async function(e) {
                ...
                if (variants && variants.length > 0) {
                        ...
                        variantsHTML += `
                            <div class="variant-item" style="background: rgba(0,0,0,0.2); padding: 12px; border-radius: 8px; margin-bottom: 8px; border: 1px solid rgba(255,255,255,0.1);">
                                ...
                                <div style="display: flex; gap: 6px; margin-bottom: 8px;">
                                    ...
                                    <button class="copy-ytdlp-cmd" data-cmd="yt-dlp &quot;${variant.url}&quot; -o output_${quality.replace('x', '_')}.mp4" style="background: rgba(239, 68, 68, 0.3); border: none; color: white; padding: 8px 12px; cursor: pointer; border-radius: 6px; font-size: 11px; font-weight: 600; flex: 1; transition: all 0.2s;">
                                        📥 yt-dlp
                                    </button>
                    ...
                    variantsContent.querySelectorAll('.copy-ytdlp-cmd').forEach(btn => {
                        btn.addEventListener('click', function(e) {
                            e.preventDefault();
                            copyToClipboard(this.dataset.cmd, this);
                        });
